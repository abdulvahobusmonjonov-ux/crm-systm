...
export default function ProfilePage() {
    ...
    return (<div className="min-h-screen bg-[#F5F6FA] dark:bg-gray-950 p-3 sm:p-4 lg:p-6 space-y-6">
        ...
        <img src={avatarUrl} alt="Avatar" className="w-full h-full object-cover"/>) : (<span className="text-lg font-semibold text-[#5E2CA5] dark:text-purple-400">
            ...
            <div className="min-w-0 flex-1 space-y-1">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {user?.role && (<span className={`inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium ${ROLE_BADGE_CLS[user.role] || "bg-gray-100 text-gray-600 dark:bg-white/8 dark:text-gray-400"}`}>
