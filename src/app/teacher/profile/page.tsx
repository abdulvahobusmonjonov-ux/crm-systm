...
export default function TeacherProfilePage() {
  ...
  const saveProfile = async () => {
    ...
    if (res.ok) toast.success("Ma'lumotlar saqlandi");
  ...
  return (
    <div className="min-h-screen bg-[#F5F6FA] dark:bg-gray-950 p-3 sm:p-4 lg:p-6 space-y-6" style={{ fontFamily: "'Inter', sans-serif" }}>
              ...
              <div className="pt-1 border-t border-gray-100 dark:border-white/10 space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <Select
                    ...
                    placeholder="Tanlang"
                    options={[{ value: "uz", label: "O'zbekcha" }, { value: "ru", label: "Ruscha" }, { value: "en", label: "Inglizcha" }]}
                  />
                  <Select
                    label="Jins"
