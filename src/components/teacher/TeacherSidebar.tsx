...
export default function TeacherSidebar({ mobileOpen = false, onClose = () => {} }: TeacherSidebarProps) {
            ...
            {soonItems.map((item) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium text-gray-300 dark:text-gray-600 cursor-not-allowed"
                >
                  <Icon className={ICON} />
                  {!collapsed && (
